package com.cdfg.printcoupon.pojo.untill;
...
public class Print implements Printable {
    ...
    public double paperW=426.63685;//打印的纸张宽度

    public double paperH=184.251967;//打印的纸张高度

    public String cardId;

    public String name;

    public Print(String cardId,String name) {
        this.cardId = cardId;
        this.name = name;
    }
